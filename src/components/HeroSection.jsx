                        ...
                        <div className="flex justify-center items-center h-full">
                            <div className="text-center text-white px-6 md:px-12">
                                ...
                                <h3 className="text-3xsm font-bold mb-8">
                                    The OASIS is an adventure too big for the
                                    real world.
                                    <br /> Are you ready for the beta stage?
                                    <br />
                                    Whether a seasoned Gunter or a curious noob,
                                    you can navigate the Starmap in search of
                                    your favorite destination planets and make
                                    your mark.
                                    <br /> The scores you rack up on each game
                                    planet will be memorialized on the OASIS
                                    beta Global leaderboard.
                                </h3>
                                <button
                                    type="button"
